# Discogs-API--Command-Line-Interface
A small project i made in order to learn more about python and using it to call API's
This is a work in progress and ill be trying to update it every few days until its in a stable position
